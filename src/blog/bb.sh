...
global_variables() {
    ...
    # Blog title
    global_title="From beginner to craftsman"
    # The typical subtitle for each blog
    global_description="A blog about craftsmanship practices, writed by a developer like you"
    # The public base URL for this blog
    global_url="http://example.com/blog"

    # Your name
    global_author="Damián Pumar"
    # You can use twitter or facebook or anything for global_author_url
    global_author_url="https://www.instagram.com/damianpumar" 
    # Your email
    global_email="damianpumar@gmail.com"
